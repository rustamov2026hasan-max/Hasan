# Agent setup for `chorva-kuzatuv`

This is a deepsec scanning workspace. Project `chorva-kuzatuv` was just registered
(target: `..`). Setup is incomplete — `data/chorva-kuzatuv/INFO.md`
...
2. **Fill in `data/chorva-kuzatuv/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id chorva-kuzatuv
pnpm deepsec process --project-id chorva-kuzatuv
```
